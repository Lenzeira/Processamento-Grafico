...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "L2_Ex05 - Quatro Viewports", nullptr, nullptr);
	if (!window)
	{
...
int setupGeometry()
{
	GLfloat vertices[] = {
		...
		300.0f, 400.0f,   0.0f,   0.3f, 0.3f, 0.3f,
		500.0f, 400.0f,   0.0f,   0.7f, 0.7f, 0.7f,
	};
